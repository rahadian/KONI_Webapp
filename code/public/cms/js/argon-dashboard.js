...
function darkMode(el) {
  ...
  const imgendless = document.querySelector('.imgendless');
  const imgendlessImg = imgendless.src;



  if (!el.getAttribute("checked")) {
    body.classList.add('dark-version');
    if (imgendlessImg.includes('endless.gif')){
        var imgendlessImgNew = imgendlessImg.replace('endless.gif','logo-probolinggo.png');
        imgendless.src = imgendlessImgNew;
    }
    if (navbarBrandImg.includes('logo-ct-dark.png')) {
      var navbarBrandImgNew = navbarBrandImg.replace("logo-ct-dark", "logo-ct");
      navbarBrand.src = navbarBrandImgNew;
    ...
    if (imgendlessImg.includes('logo-probolinggo.png')){
        var imgendlessImgNew = imgendlessImg.replace('logo-probolinggo.png','endless.gif');
        imgendless.src = imgendlessImgNew;
    }
    if (navbarBrandImg.includes('logo-ct.png')) {
      var navbarBrandImgNew = navbarBrandImg.replace("logo-ct", "logo-ct-dark");
