<footer class="footer pt-3" style="position: fixed; bottom: 0; width: 100%;">
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                Komite Olahraga Nasional Indonesia Kabupaten Probolinggo.
              </div>
            </div>
          </div>
        </div>
...
<script>
  ...
  <script src="{{ asset('cms/js/argon-dashboard.min.js?v=2.0.6') }}"></script>
  {{-- <script src="{{ asset('cms/js/argon-dashboard.js?v=4') }}"></script> --}}
