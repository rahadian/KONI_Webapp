        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Tambah Informasi (Berita dan Pengumuman)</h6>
              @if (session('status'))
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ route('informasi.store') }}" class="style-form">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="content-editor" placeholder="Enter the Content" rows="5" name="content"></textarea>

                </div>
                <div class="form-group">
                    <label for="tanggal">Tanggal</label>
                    <input type="text" class="form-control border rounded w-10" id="tanggal" name="tanggal" autocomplete="off" required>
                </div>
                 <div class="form-group">
