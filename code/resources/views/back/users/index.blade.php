        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            @if (session('status'))
                ...
                @endif
              <h6>List Users</h6>
              <a href="{{ route("users.create") }}"><button type="button" class="btn btn-primary btn-fill" style="float:left;"><i class="fa fa-plus"></i> Tambah User</button></a>
            </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center text-sm">
                        @if($dt->role=='admin')
                        <span class="badge badge-sm bg-gradient-success">{{ $dt->role }}</span>
                        @else
                        <span class="badge badge-sm bg-gradient-secondary">{{ $dt->role }}</span>
                        @endif
                      </td>
