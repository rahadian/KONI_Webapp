                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{ Str::limit(strip_tags($dt->deskripsi), 100, ' ...') }}</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <img src="{{ asset('uploads/' . $dt->gambar) }}" style="width:80px">
                      </td>
                      ...
                      <td class="align-middle text-center">
                        <a class="btn btn-fill btn-info" href="{{ route("ikhtisar.edit",[$dt->id]) }}" title='View Detail'><i class="fa fa-eye"></i></a>
