      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ route('limit_nominal.update',[$data->id]) }}" class="style-form">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select name="tahun" id="year" class="form-control select border rounded w-10" required>
                ...
                <div class="form-group" id="cabor-container">
                    ...
                    <select id="cabor" name="cabor" class="form-control select border rounded w-10" required>
                        <option value="{{ $data->cabor }}">{{ $data->cabor }}</option>
                        <hr>
                ...
                <div class="form-group">
                    <label for="nominal">Nominal</label>
                    <input type="text" class="form-control w-10" id="nominal" name="nominal" value="{{ number_format($data->nominal, 0, ',', '.') }}" required>
                </div>
                <div class="form-group" id="smt1">
                    <label for="smt1">Semester 1</label>
                    <input type="text" class="form-control w-10" id="semester1" name="semester1" value={{ number_format($data->semester1, 0, ',', '.') }} required>
                </div>
                <div class="form-group" id="smt2">
                    <label for="smt2">Semester 2</label>
                    <input type="text" class="form-control w-10" id="semester2" name="semester2" value={{ number_format($data->semester2, 0, ',', '.') }} required>
                </div>
