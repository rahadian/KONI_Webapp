        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Tambah Pelatih Cabor {{ $nama_cabor }}</h6>
              @if (session('status'))
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ route('pelatih_cabor.store') }}" class="style-form">
                @csrf
                ...
                <div class="form-group">
                    <label for="image">Sertifikat</label><br>
                ...
                <a href="{{ route('pelatih_cabor.index') }}" class="btn btn-danger btn-fill pull-left">Kembali</a>
            </form>
            </div>
          </div>
        </div>
