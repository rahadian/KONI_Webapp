        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            @if (session('status'))
                ...
                @endif
              <h6>Data Atlit Cabor {{ $nama_cabor }}</h6>
              @if(Auth::user()->role=="cabor")
              <a href="{{ route("atlit_cabor.create") }}"><button type="button" class="btn btn-primary btn-fill" style="float:left;"><i class="fa fa-plus"></i> Tambah Atlit</button></a>
              @endif
            </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <img src="{{ asset('uploads').'/'.$dt->kk}}" style="width:30px">
                          </div>
                        </div>
                      </td>
                      ...
                      @if(Auth::user()->role=="cabor")
                        <a class="btn btn-fill btn-info" href="{{ route("atlit_cabor.edit",[$dt->id_atlit]) }}" title='View Detail'><i class="fa fa-eye"></i></a>

                        <form onsubmit="return confirm('Anda Yakin untuk Menghapus Data Ini ?')" class="d-inline" action="{{ route('atlit_cabor.destroy',[$dt->id_atlit]) }}" method="post">
                        @csrf
